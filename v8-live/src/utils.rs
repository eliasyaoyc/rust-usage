use v8::{
    script_compiler, HandleScope, Module, Promise, Script, ScriptOrModule, ScriptOrigin, TryCatch,
};
...
pub fn execute_script<'s>(
    ...
    if is_module {
        ...
        match promise.state() {
            v8::PromiseState::Pending => panic!("We don't know how to process pending."),
